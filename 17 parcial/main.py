...
# 4. La opción 10 del menú, le solicitará al usuario que ingrese un presupuesto. El programa
...
# y el listado.
# 5. La opción 11 del menú, le solicitará al usuario el nombre de un proyecto. Realizar un informe
